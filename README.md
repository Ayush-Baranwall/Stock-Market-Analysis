...
## Dataset: The historical daily stock data for google is available from "2004" to "2023" with a daily interval but we have only included the data from 2015 to 2020 as google launched less products and due to this the stock prices enourmously decreased but in 2020 as google launched various products and because of the pandemic people started using a lot of google products, it's share price increased a lot.
